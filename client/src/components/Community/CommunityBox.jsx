  ...
  return (
    <div>
      <div className="p-4">
        ...
        <button
          className="relative w-full md:w-[310px] h-[150px] bg-gradient-to-t from-[#0d8007] via-[#0d8007] to-[#0d8007] text-white rounded-2xl border-none outline-none cursor-pointer overflow-hidden shadow-[0_15px_30px_rgba(0,0,0,0.5)] group"
